...
inputRojo.addEventListener('change', (e) => {
  ...
  console.log(inputRojo.value)
  document.getElementById("texto-rojo").innerHTML = inputRojo.value;
...
inputVerde.addEventListener('change', (e) => {
  // Actualiza el valor de la variable y el texto.
  // Llama a la función para actualizar el color de fondo.
  document.getElementById("texto-verde").innerHTML = inputVerde.value;
  actualizarColor(inputRojo.value, inputVerde.value, inputAzul.value);
});
...
inputAzul.addEventListener('change', (e) => {
  // Actualiza el valor de la variable y el texto.
  // Llama a la función para actualizar el color de fondo.
  document.getElementById("texto-azul").innerHTML = inputAzul.value;
  actualizarColor(inputRojo.value, inputVerde.value, inputAzul.value);
});
